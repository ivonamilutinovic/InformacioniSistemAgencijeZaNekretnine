...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.51\textheight]{Pictures/DodavanjeNovogZaposlenogRadnika.jpg}\\
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.59\textheight]{Pictures/IzmenaOglasaOdStraneKorisnika.jpg}\\
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.59\textheight]{Pictures/PravljenjeRezervneKopije.jpg}\\
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.74\textheight]{Pictures/DodavanjeNovogRegistrovanogKorisnika.jpg}\\
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.5\textheight]{FP_Slike/3-ekranRegistruj.png}\\
        \caption{Predlog izgleda korisni\v ckog interfejsa: Registracija novog korisnika}
   \end{figure}
\newpage
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.5\textheight]{FP_Slike/4-ekranPotRegistracije.png}\\
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.60\textheight]{Pictures/BrisanjeNalogaUsledNeadekvatnogKoriscenja.jpg}\\
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.35\textheight]{Pictures/BrisanjeNalogaNaZahtevKorisnika.jpg}\\
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.3\textheight]{FP_Slike/izmenaPodataka.png}\\
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.3\textheight]{FP_Slike/potvrdaBrisanjaNaloga.png}\\
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.74\textheight]{Pictures/IzmenaInformacijaNalogaKorisnika.jpg}\\
...
\begin{longtable}{p{0.23\linewidth} p{0.77\linewidth}}
 % Kratak opis
 \hline
 {\it \bfseries Kratak opis} & Ovaj slu\v{c}aj upotrebe opisuje postupak postavljanja oglasa za prodaju ili izdavanje nekretnine od strane Nalogodavca prodavca ili Nalogodavca zakupodavca na internet stranicu agencije.
 % Akteri
 \hline
 {\it \bfseries Akteri} & \begin{itemize}
...
\hline
 ...
 % Glavni tok
     ...
     \begin{enumerate}
         ...
         \item  Agent pose\'{c}uje Nalogodavca kako bi procenio vrednost nekretnine u odnosu na trenutno stanje na tr\v{z}i\v{s}tu i preuzeo dokumentaciju koju predaje advokatu na uvid.
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.35\textheight] {Pictures/DijagramAktivnostiOnlineZakazivanjeGledanja.png}\\
...
{\it Napomena}: u slede\' coj tabeli se pod klijentom smatraju kako Nalogodavci prodavci i zakupodavci, tako i Nalogodavci kupci i zakupci.
\begin{center}
\begin{longtable}{p{0.23\linewidth} p{0.77\linewidth}}
 % Akteri
 \hline
...
% Opis
 {\it \bfseries Kratak opis} & Klijenti ocenjuju i komentari\v{s}u uslugu agenta preko svog profila na veb stanici agencije.\\ 
 \hline
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.35\textheight] {FP_Slike/6-ekranPrijavljen.png}\\
        \caption{Predlog izgleda grafi\v ckog korisni\v ckog interfejsa: Ocena agenta nakon gledanja nekretnine od strane klijenta}
...
\textbf{\textit{Alternativni tokovi}} & 
\begin{itemize}
\item Alternativni tok 1: Ako nekretnina nije uknji\v zena i ako je nekretnina ste\v cena na osnovu zakona (a ovde \' ce to agencija omogu\' citi), teret dokazivanja pravnog sleda nije na kupcu, i on se registruje kao novi vlasnik. U tom smislu, u ovom slu\v caju prodavac ne mora ni\v sta da radi i postupak se nastavlja od ta\v cke 4. 
\item Alternativni tok 2: Nastaje ako nekretnina ima tereta. Advokat obave\v stava prodavca / zakupca da namiri svoje poreske obaveze. Ako prodavac / zakupac namiri svoje obaveze, prelazi se na ta\v cku 5. Ako prodavac / zakupac ne namiri svoje obaveze, postupak se prekida, smatra se da prodavac / zakupac zloupotrebljava svoj nalog i nalog se uklanja. 
\end{itemize}
\hline
\end{longtable}
\end{center}
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.77\textwidth,height=0.65\textheight]{Pictures/DijagramAktivnostiProveraUknjizenosti.png}\\
...
% Alternativni tok
 {\it \bfseries Alternativni tok} & 
 \begin{itemize}
     \item Alternativni tok 1: U slu\v caju da prodavac / zakupodavac ima bra\v cnog druga, on dostavlja potpisanu izjavu o saglasnosti bra\v cnog druga sa prodajom / izdavanjem nekretnine advokatu. Ako ne dostavi potrebnu saglasnost, slu\v caj upotrebe se zavr\v sava.
     \item Alternativni tok 2: Ako jo\v s neko ima pravo na nekretninu, radi se o do\v zivotnom izdr\v zavanju ili o ugovoru o poklonu. Ako je u pitanju ugovor o poklonu, potrebno je tra\v ziti i saglasnost drugog deteta ili naslednika ako ga ima. Ako se dobije saglasnost, slu\v caj upotrebe se nastavlja u koraku 2, glavnog toka, u suprotnom, postupak se prekida.
    \item Alternativni tok 3: Jo\v s neko ima pravo na nekretninu i u pitanju je do\v zivotno izdr\v zavanje. Treba pogledati i imovinsku raspravu. Ako je sve u redu, slu\v caj upotrebe se nastavlja u koraku 2 glavnog toka. U suprotnom se zavr\v sava slu\v caj upotrebe. 
\end{itemize}
 \hline
\end{longtable}
\end{center}
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.7\textheight]{Pictures/raskidUgovoraOdStraneKlijenta}\\
...
\begin{longtable}{p{0.23\linewidth} p{0.77\linewidth}}
 % Kratak opis
 \hline
 {\it \bfseries Kratak opis} & Ovaj slu\v{c}aj upotrebe opisuje izvr\v{s}avanje zadu\v{z}enja fotografa u cilju sakupljanja materijala za postavljanje oglasa za nekretninu.
 % Akteri
\hline
 {\it \bfseries Akteri} & \begin{itemize}
    \item Profesionalni fotograf
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth,height=0.74\textheight]{Pictures/AgencijaZaNekretnine.png}\\
