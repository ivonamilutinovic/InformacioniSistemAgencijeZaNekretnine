...
\hline
% Opis
 {\it \bfseries Kratak opis} & U prostorijama agencije se zaklju\v {c}uje ugovor izme\dj u nalogodavca prodavca i agenta kao predstavnika agencije.\\ 
 \hline
 % Ulaz
 ...
 % Glavni tok
     ...
     \begin{enumerate}
         ...
         \item  Agent koji je slobodan u tom trenutku poziva nalogodavca prodavca u kancelariju.
         \item  Nalogodavac prodavac dobija tri primerka ugovora od strane agenta.
         \item  Nalogodavac prodavac potpisuje sva tri primerka i predaje ih agentu.
         \item  Agent proverava ispravnost sva tri potpisa.
         \item  Agent tako\dj e potpisuje sva tri primerka, jedan primerak vra\' ca nalogodavcu prodavcu a dva zadr\v {z}ava u agenciji.
         \item  Nalogodavac prodavac pla\' ca agenciji proviziju od 1.9\% definisanu ugovorom kada mu na\dj e kupca.
    \end{enumerate}\\
 \hline

 % Alternativni tok
 {\it \bfseries Alternativni tok} & U slu\v {c}aju da agencija u naredna tri meseca od potpisivanja ugovora sa nalogodavcem prodavcem ne na\dj e kupca za njegovu nekretninu ugovor se automatski raskida. Slu\v {c}aj upotrebe se zavr\v {s}ava.\\
 \hline
% Dodatne informacije
 {\it \bfseries Dodatne\newline informacije} & /\\
 \hline
...
\hline
% Opis
 {\it \bfseries Kratak opis} & U prostorijama agencije se zaklju\v {c}uje ugovor izme\dj u nalogodavca zakupca i agenta kao predstavnika agencije.\\ 
 \hline
 % Ulaz
 {\it \bfseries Ulaz} & Potrebna dokumenta\\
 \hline
 ...
 % Glavni tok
     ...
     \begin{enumerate}
         ...
         \item Agent koji je slobodan u tom trenutku poziva nalogodavca zakupca u kancelariju. 
         \item Nalogodavac zakupac dobija tri primerka ugovora od strane agenta.
         \item Nalogodavac zakupac potpisuje sva tri primerka i predaje ih agentu.
         \item Agent proverava ispravnost sva tri potpisa.
         \item Agent tako\dj e potpisuje sva tri primerka, jedan primerak vra\' ca nalogodavcu zakupcu a dva zadr\v {z}ava u agenciji.
         \item Agent obave\v {s}tava nalogodavca zakupca kada mu agencija na\dj e zakupodavca. 
    \end{enumerate}\\
 \hline
 % Alternativni tok
 {\it \bfseries Alternativni tok} & / \\ 
...
\hline
% Opis
 {\it \bfseries Kratak opis} & U prostorijama agencije se zaklju\v {c}uje ugovor izme\dj u nalogodavca kupca i agenta kao predstavnika agencije.\\ 
 \hline
 % Ulaz
 {\it \bfseries Ulaz} & Potrebna dokumenta\\
 \hline
 ...
 % Glavni tok
     ...
     \begin{enumerate}
         ...
         \item Agent koji je slobodan u tom trenutku poziva nalogodavca kupca u kancelariju. 
         \item Nalogodavac kupac dobija tri primerka ugovora od strane agenta.
         \item Nalogodavac kupac potpisuje sva tri primerka i predaje ih agentu. 
         \item Agent proverava ispravnost sva tri potpisa.
         \item Agent potpisuje tako\dj e sva tri primerka, jedan primerak vra\' ca nalogodavcu kupcu a dva zadr\v {z}ava u agenciji.
         \item Nalogodavac kupac pla\' ca agenciji proviziju od 1.9\% definisanu ugovorom kada mu prona\dj e prodavca.
    \end{enumerate}\\
 \hline
 % Alternativni tok
 {\it \bfseries Alternativni tok} & / \\ 
...
\hline
% Opis
 {\it \bfseries Kratak opis} & U prostorijama agencije se zaklju\v {c}uje ugovor izme\dj u nalogodavca zakupodavca i agenta kao predstavnika agencije.\\ 
 \hline
 % Ulaz
 {\it \bfseries Ulaz} & Potrebna dokumenta\\
 \hline
 ...
 % Glavni tok
     ...
     \begin{enumerate}
         ...
         \item Agent koji je slobodan u tom trenutku poziva nalogodavca zakupodavca u kancelariju. 
         \item Nalogodavac zakupodavac dobija tri primerka ugovora od strane agenta.
         \item Nalogodavac zakupodavac potpisuje sva tri primerka i predaje ih agentu. 
         \item Agent proverava ispravnost sva tri potpisa.
         \item Agent tako\dj e potpisuje sva tri primerka, jedan primerak vra\' ca nalogodavcu zakupodavcu a dva zadr\v {z}ava u agenciji. 
         \item Nalogodavac zakupodavac pla\' ca agenciji proviziju od 49\% od prve kirije definisanu ugovorom kada mu agencija na\dj e zakupca.
    \end{enumerate}\\
 \hline
 % Alternativni tok
 {\it \bfseries Alternativni tok} & / \\ 
